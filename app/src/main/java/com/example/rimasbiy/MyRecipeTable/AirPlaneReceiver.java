...
public class AirPlaneReceiver extends BroadcastReceiver {
    private Button save;
//الـ BroadcastReceiver عادةً لا يعرف شيئاً عن واجهة المستخدم (UI). لكي نجعله يتحكم في زر الـ "Save" الموجود في شاشة إضافة الوصفة، قمنا بتمرير هذا الزر كـ "بارامتر" عند إنشاء الكلاس. تمرير الزر من الـ Activity
    public AirPlaneReceiver(Button buttonsaverecipe) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // يضمن أن تطبيقك يستجيب فقط لتغييرات وضع الطيران، لكي يتمكن من قفل أو فتح زر الحفظ في الوقت المناسب تماماً.
        if (Intent.ACTION_AIRPLANE_MODE_CHANGED.equals(intent.getAction())) {
            ...
            if (isEnabled) {// إذا وضع الطيران شغال
                ...
                save.setEnabled(false);////تعطيل زر الحفظ (Save Button)
                save.setText("AirPalne is on");////غيير النص المكتوب فوق الزر.
            } else {///وضع الطيران غير فعّال
