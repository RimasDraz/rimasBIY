...
//وظيفته ببساطة هي استقبال "موضوع" أو "أكلة" من المستخدم، وإرسالها إلى ذكاء Gemini الاصطناعي ليقوم بتوليد خطوات واضحة (Checklist) لكيفية تنفيذ هذه الوصفة.
...
//"استخدم طبقة توافق Java (GenerativeModelFutures) التي توفر الدعم لواجهات برمجة التطبيقات من نوع ListenableFuture و Publisher."
        ...
        btnSuggestSteps.setOnClickListener(new View.OnClickListener() {
            ...
            private void askFirebaseAiGeminiForRecipe(String topic) {
...
//إرسال الطلب واستلام "وعد" (Future) بالاستجابة المستقبليّة
                ...
                Executor executor = SmartRecipeAssistant.this::runOnUiThread;//هذا يضمن أن تحديث النصوص والأزرار سيتم على الشاشة مباشرة بدون أخطاء
